...
function repeatRoute1(route, routeIndex) {
    ...
    }, route.route_name !== this.current_route_name ? React.createElement('img', { 'src': '/assets/img/' + route.key + '-green.svg' }) : null, route.route_name === this.current_route_name ? React.createElement('img', { 'src': '/assets/img/' + route.key + '-blue.svg' }) : null, React.createElement('div', {}, this.t(`${ route.key }.title`)));
}
export default function () {
    return React.createElement('div', { 'id': 'cc_calculator_ui' }, React.createElement('nav', { 'className': 'navbar navbar-default' }, React.createElement.apply(this, [
        'div',
        { 'id': 'cc_nav' },
