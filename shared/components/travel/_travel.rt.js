...
function repeatVehicle2(vehicle, vehicleIndex) {
    return React.createElement('div', {
        ...
        'onChange': this.updateVehicle.bind(this, vehicle)
    }), React.createElement('div', { 'id': vehicle.slider_id }), React.createElement('div', { 'className': 'question--vehicle__mpg-label' }, this.t('travel.miles_per_gallon')), React.createElement('span', {
